  ...
  return (
    <div>
        <header >
            ...
            <h2 className='subheading'>Everyone struggles doing their daily task. With Summon Success, you turn your productivity into your very own thriving magic shop! </h2>
        ...
        <section className='dark map-img' >
            <div className='call-to-action'>
                <h1>Ready to start summoning success?</h1>
